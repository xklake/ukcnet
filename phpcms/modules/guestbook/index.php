	...
	public function register() { 
 		...
 		if(isset($_POST['dosubmit'])){
			...
			if($_POST['tel']==""){
			 ...
			 /*添加用户数据*/
 			$sql = array('siteid'=>$siteid,'typeid'=>$_POST['typeid'],'name'=>$_POST['name'],'sex'=>$_POST['sex'],'lxqq'=>$_POST['lxqq'],'email'=>$_POST['email'],'tel'=>$_POST['tel'],'introduce'=>$_POST['introduce'],'addtime'=>time());
