...
#content{width:890px; margin:0px auto; padding:50px; overflow:auto;background-color:#e2e1ed;border-left:1px #08086b  solid;border-right:1px #08086b  solid;}
...
.form-login .input label{ width:84px;font-size:14px; color:#494949; text-align:right; float:left}
...
.form textarea{width:318px;height:300px;}
