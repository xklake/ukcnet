<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div class="space"></div>
	 <div class="copyright">
		  <p class="btp"><a class="cfff" href="<?php echo $CATEGORYS['13']['url'];?>">联系我们</a> | <a  class="cfff" href="<?php echo $CATEGORYS['32']['url'];?>">加入会员</a> | <a class="cfff" href="<?php echo $CATEGORYS['9']['url'];?>">协会活动</a> | <a  class="cfff"href="<?php echo $CATEGORYS['6']['url'];?>">协会介绍</a> </p>
